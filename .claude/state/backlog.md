...
### R3 · E2E journey — one Playwright test of the full DoD path — `[e2e]` — size: **M** — status: **todo (queued robustness insurance; long-standing `E2E · One DoD journey` item, now promoted into the ordered queue)**
